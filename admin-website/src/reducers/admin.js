...
export const types = {
  ...
  GENERATING_CERT_HASH_SUCCESS: "GENERATING_CERT_HASH_SUCCESS",
  GENERATING_CERT_HASH_FAILURE: "GENERATING_CERT_HASH_FAILURE",
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.DEPLOYING_STORE_SUCCESS:
      ...
      case types.GENERATE_HASH:
        return {
          ...state,
          generatinghash: true
        };
      case types.GENERATING_CERT_HASH_SUCCESS:
        return {
          ...state,          
          certHash: action.payload.certHash          
        };
...
export function getHash(store) {
  console.log("inside gethash admin.js"+ store.admin.certHash);
  return store.admin.certHash;
}
